...
Product-minded full-stack engineer with 5+ years of experience turning ambiguous operational needs into shipped software. Owns delivery across React/Next.js frontends, FastAPI services, data models, testing, and CI/CD, with a track record of building products from an empty repository to production.
...
**Cosmora** — _Founder / Product Engineer_ · Local-first **salon operations** product built with **Tauri, React, TypeScript, SQLite, and Rust**, designed for privacy and reliable offline use.
...
**Infrastructure & Quality** — Docker · GitHub Actions · GHCR · AWS · Vitest · React Testing Library · pytest  
**AI & Automation** — Claude Code · Skills · Hooks  
