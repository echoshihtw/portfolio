...
export const heroConfig: {
  ...
  support:
    "Product Engineer who owns problems end to end: working out what to build, building it, shipping it, and keeping it running. I stay with a problem because the experience breaks at the seams — a slow endpoint, a failed release, an app that gives up when the Wi-Fi does. React, TypeScript and Node.js, with Python and FastAPI behind them.",
