...
export const skills: SkillGroup[] = [
  ...
  {
    category: "Frontend",
    items: ["React", "Next.js", "SvelteKit", "TailwindCSS"],
  },
  {
  ...
  {
    category: "Backend:",
    items: ["Node.js", "Python", "FastAPI", "ArangoDB", "RabbitMQ", "Supabase"],
  },
  {
    category: "Desktop / Local-First",
    items: ["Tauri", "Electron", "SQLite", "Rust"],
  },
  {
  ...
  {
    category: "AI & LLM",
    items: ["LangChain", "OpenAI APIs", "Prompt Engineering", "---"],
  },
];
