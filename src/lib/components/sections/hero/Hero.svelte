...
<style>
  ...
  :global(html[data-theme="dark"]) .hero-section::after {
    background: linear-gradient(
      to bottom,
      rgba(17, 17, 16, 0),
      rgba(17, 17, 16, 0.24)
  ...
  .hero-title {
    ...
    text-shadow:
      ...
      0 10px 26px rgba(200, 169, 126, 0.14);
    max-width: 16ch;
  }
  ...
  :global(html[data-theme="dark"]) .hero-cta {
  ...
  :global(html[data-theme="dark"]) .hero-cta:hover {
